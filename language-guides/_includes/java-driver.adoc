...
[source, java]
----
include::https://github.com/neo4j/neo4j-java-driver/blob/1.4/examples/src/main/java/org/neo4j/docs/driver/HelloWorldExample.java[tag=hello-world-import]

include::https://github.com/neo4j/neo4j-java-driver/blob/1.4/examples/src/main/java/org/neo4j/docs/driver/HelloWorldExample.java[tag=hello-world]
----
...
| http://stackoverflow.com/questions/tagged/neo4j+java[icon:stack-overflow [] StackOverflow]
